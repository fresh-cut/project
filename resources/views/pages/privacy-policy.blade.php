...
@section('title')
    {{ settings_translate('footer_privacy_policy_text', 'Privacy Policy') }}
@endsection
@section('description'){{settings_translate('footer_privacy_policy_text', 'Privacy Policy')}}@endsection
<style>
    h1 {
        margin-bottom: 10px;
        font-size: 26px;
...
<section class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ol class="pl-4" align="justify">
                ...
                <li>
                    ...
                    <ul class="pl-5">
                        ...
                        <li type="disc">
                            the existence of automated decision-making tools, including profiling, referred to in Article 22(1) and (4) of the GDPR and, at least in those cases, meaningful information about the logic involved, as well as the significance and envisaged consequences of such processing for the data subject.
                        </li>
                    </ul>
                    <p align="justify">
            ...
            <h2>12. Data protection provisions about the application and use of third parties</h2>
            <h3>12.1 Data protection provisions about the application and use of Facebook</h3>
            <p align="justify">
            ...
            <p align="justify">
                The purpose of Google's AdSense component is the integration of advertisements on our website. Google AdSense places a cookie on the information technology system of the data subject. The definition of cookies is explained
                <a href="" target="_blank">in the Cookies Policy</a>.
                With the setting of the cookie, Alphabet Inc. is enabled to analyze the use of our website. With each call-up to one of the individual pages of this Internet site, which is operated by the controller and into which a Google AdSense component is integrated, the Internet browser on the information technology system of the data subject will automatically submit data through the Google AdSense component for the purpose of online advertising and the settlement of commissions to Alphabet Inc. During the course of this technical procedure, the enterprise Alphabet Inc. gains knowledge of personal data, such as the IP address of the data subject, which serves Alphabet Inc., inter alia, to understand the origin of visitors and clicks and subsequently create commission settlements.
            </p>
            <p align="justify">
            ...
            <p align="justify">
                ...
                <a href="https://www.google.com/intl/en/adsense/start/" target="_blank">https://www.google.com/intl/en/adsense/start/</a>.
            </p>

            <h3>12.3 Data protection provisions about the application and use of Google Analytics (with anonymization function)</h3>
            <p align="justify">
            ...
            <p align="justify">
                ...
                and under
                <a href="http://www.google.com/analytics/terms/us.html" target="_blank">http://www.google.com/analytics/terms/us.html</a>.
                Google Analytics is further explained under the following Link
                <a href="https://www.google.com/analytics/" target="_blank">https://www.google.com/analytics/</a>.
            </p>
            ...
            <p align="justify">
                Hotjar provides a tracking code that is used to collect your information and to send it to Hotjar’s Ireland servers.
            </p>
            <p align="justify">
                When you visit a website that uses Hotjar, the tracking code collects information automatically about your activities and stores them on its servers for analysis. What cookies are, we already explained
                <a href="#" target="_blank">in the Cookies Policy</a>.
            </p>
            <p align="justify">
            ...
            <p align="justify">
                ...
                <a href="#" target="_blank">in the Cookies Policy</a>,
                through an appropriate setting of the browser used, and thus permanently prohibit their use. Such a setting of the web browser will also prohibit Hotjar to place a cookie on the computer system of the data subject. In addition, a set of cookies Hotjar already installed can be deleted at any time via web browser or other software programs.
            </p>
            <p align="justify">
                The information collected can be accessed only by specifically designated users for Hotjar’s customer’s account. In certain circumstances, Hotjar and Amazon Web services can access this information.
            </p>
            <p align="justify">
                Except as provided in this section, your personal information is not rented, sold or disclosed by Hotjar to third parties for their own use.
            </p>
            <p align="justify">
                Additional information and Hotjar’s privacy policy can be found on the following addresses
                <a href="https://www.hotjar.com/legal/policies/privacy" target="_blank">https://www.hotjar.com/legal/policies/privacy</a>
                and
                <a href="https://www.hotjar.com/legal/policies/terms-of-service" target="_blank">https://www.hotjar.com/legal/policies/terms-of-service</a>.
            </p>

            <h3>12.5 Data protection provisions about the application and use of Google Remarketing</h3>
            <p align="justify">
            ...
            <p align="justify">
                If a data subject reaches our website via a Google ad, a conversion cookie is filed on the information technology system of the data subject through Google. The definition of cookies is explained
                <a href="" target="_blank">in the Cookies Policy</a>.
            ...
            <h3>12.11 Data protection provisions about the application and use of Matomo</h3>
            <p align="justify">
            ...
            <h3>12.15 Data protection provisions about the application and use of DoubleClick</h3>
            <p align="justify">
            ...
            <p align="justify">
                ...
                <a href="" target="_blank">in the Cookies Policy</a>.
                The purpose of the cookie is the optimization and display of advertising. The cookie is used, inter alia, to display and place user-relevant advertising as well as to create or improve reports on advertising campaigns. Furthermore, the cookie serves to avoid multiple display of the same advertisement.
            </p>
            <p align="justify">
            ...
            <h2>16. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into a contract; Obligation of the data subject to provide the personal data; possible consequences of failure to provide such data</h2>
            <p align="justify">

            ...
            <ol>
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(1);">1. What is CyberCubex Directory Local Search?</p>
                        <div>
                            <div id="id_1" class="hide panel-body">
                                <p align="justify">
                                    CyberCubex Directory is registered in the USA and manages online business directories under the brand name of UsaIsOnline.com Local Search.
                                </p>
                                <p align="justify">
                                ...
                                <p align="justify">
                                    CyberCubex Directory Local Search also displays business directories in other countries - for example, we’re also present in the USA, South Africa, Spain, Canada, Australia, Hungary, France, Italy, or the United Kingdom.
                                </p>
                                <p align="justify">
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(2);">2. How can I add my company to CyberCubex Directory Local Search?</p>
                        <div>
                            <div id="id_2" class="hide panel-body">
                                <p align="justify">
                                    It’s totally free and easy to add a company to our business directory. From the home page, click on the "Add listing" link in the footer and simply fill in the required fields. </p>
                            </div>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(3);">3. Can I add more branches of the same company to CyberCubex Directory?</p>
                        <div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div>
                            <div id="id_4" class="hide panel-body">
                                ...
                                <p align="justify">
                                    If you need help, you can always send us a message via the contact form. <p><a href="https://usaisonline.com/contact-us" target="_blank" rel="noopener">Contact us</a></p>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(5);">5. How can I update my business information on CyberCubex Directory Local Search?</p>
                        <div>
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(7);">7. How can I delete my company from CyberCubex Directory Local Search?</p>
                        <div>
                            <div id="id_7" class="hide panel-body">
                                <p align="justify">
                                    On your company profile, you can find a button marked ‘REPORT INCORRECT DATA’. Click on it, then from the drop-down list, choose 'Remove listing’. Simply click on the button, fill in the required fields and your business information will be removed from our directory once it is reviewed by one of our operators. The deletion process can only be done by the CyberCubex Directory staff.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div>
                            <div id="id_11" class="hide panel-body">
                                <p align="justify">
                                   The direct link between the map and the company’s address is created by automated software. It is possible that because of name similarity or the absence of a road on a map, another road with a similar name may be shown instead of the street you wanted. We apologize for the discomfort created.                                </p>
                            </div>
                        </div>
                    </div>
                </li>
                            ...
                            <div id="id_14" class="hide panel-body">
                                ...
                                <ul class="pl-5">
                                    <li type="1">
                                        ...
                                        Our ranking algorithm is based on categories and keywords. That's why you should add relevant keywords to your CyberCubex Directory profile and double-check your categories.
                                    </li>
                                    <li type="1">
                                    ...
                                    <li type="1">
                                        ...
                                        Sending offers for the quote requests that you receive from your business category has a positive impact because winning offers can also earn you a higher ranking in our directory, not to mention the new customers that you can gain. A review from a ' CyberCubex Quote Requests' customer has even more value.
                                    </li>
                                    <li type="1">
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(16);">16. What other free services does CyberCubex offer?</p>
                        <div>
                            <div id="id_16" class="hide panel-body">
                                <p align="justify">
                                    Most of our products and services are free. On your presentation page, with the help of the 'Edit your page' button you can publish offers, articles, news, create a products and services catalog, upload video presentations, etc., all these services being optimized for Google search.                                </p>
                            </div>
                        </div>
                    </div>
                </li>
                            ...
                            <div id="id_17" class="hide panel-body">
                                ...
                                <ul class="pl-5">
                                    ...
                                    <li type="1">
                                        ...
                                        <br>
                                        The people who are part of the CyberCubex community or join our site are real people looking for a way to find trustworthy companies that perform high-quality work.
                                    </li>
                                    <li type="1">
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(18);">18. How can I change my profile details in CyberCubex Community?</p>
                        <div>
                ...
                <li>
                    <div class="panel panel-default">
                        <p class="item" onclick="showhide(19);">19. Is CyberCubex free?</p>
                        <div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div>
                            <div id="id_20" class="hide panel-body">
                                <p align="justify">
                                    Tagline Promotions help businesses attract customers and have a better ranking in the CyberCubex search results.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div>
                            <div id="id_21" class="hide panel-body">
                                <p align="justify">
                                    The top companies list is based on a score put together by several factors, such as audit reports, visibility index on CyberCubex and search engines, third-party or CyberCubex reviews. Ask for a free audit to see if your company can be on this list by simply sending us an email via the contact form.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div>
                            <div id="id_23" class="hide panel-body">
                                <p align="justify">
                                    CyberCubex Local Search is available in the following countries:
                                </p>
                                <table class="table">
                                    <tr>
                                        <td>Argentina</td>
